...
const questions = [
  ...
  {
    section: "Java",
    question: "If you want to print something in the console, what code do you enter?",
    options: [
      "println.system<em>out</em> (\"Hello World\");",
      "System<em>out<em/>.println (\"Hello World\");",
      "Println.system<em>in<em/> (\"Hello World\"):",
      "System<em>out<em/>.println (\"Hello World\"):"
    ],
    answer: "System<em>out<em/>.println (\"Hello World\");"
  },
  {
    section: "Java",
